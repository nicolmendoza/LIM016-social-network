...
// eslint-disable-next-line max-len
// export const uploadTask = (imgUpload, metadata) => uploadBytesResumable(storageRef, imgUpload, metadata);
...
// //   });
// // };
// export const getPhotoURL = () => getDownloadURL(uploadTask.snapshot.ref);